...
//        var result: T!
//
//        if T.self is Response<Currency>.Type {
//            result = Response<Currency>() as! T
//        }
//
//        return result
//    }
...
////            AppLogger.debug("StubResponseProvider -- get() -- response = \((try? JSONSerialization.jsonObject(with: data ?? Data([]), options: .allowFragments)) ?? NSDictionary())")
//
//        return data
//    }
//}
