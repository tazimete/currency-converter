...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func buildAppConfig() -> Void {
        let themeColors = Colors(primaryDark: .systemBlue, primaryLight: .systemOrange, secondaryDark: .black, secondaryLight: .systemBlue, textColorDark: .black, textColorLight: .white, primaryBackgroundColor: .white, secondaryBackgroundColor: .midnightBlue, disabledTextColor: .lightGray, whiteTransparentColor: .init(white: 1, alpha: 0.5))
